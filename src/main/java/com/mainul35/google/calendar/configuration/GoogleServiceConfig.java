...
public class GoogleServiceConfig {
    ...
    private static final String APPLICATION_NAME = "Google Calendar API with Spring Boot";
    ...
    private Credential getCredentials(final NetHttpTransport HTTP_TRANSPORT) throws IOException {
        // Load client secrets.
        InputStream in = GoogleServiceConfig.class.getResourceAsStream(CREDENTIALS_FILE_PATH);
        if (in == null) {
...
/*
    public GoogleTokenResponse getTokenResponse (String authCode) throws GeneralSecurityException, IOException {
        // Load client secrets.
        InputStream in = GoogleServiceConfig.class.getResourceAsStream(CREDENTIALS_FILE_PATH);
        if (in == null) {
            throw new FileNotFoundException("Resource not found: " + CREDENTIALS_FILE_PATH);
